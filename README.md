...
task 2 a script that prinnts all the groups the current user is part of
task 3 a script that changes the owner of the file hello to the user betty
task 4 a script that creates an empty file called hello
task 5 a script that adds execute permission to the owner of the file
task 6 a script that adds execute permission to the owner of and the group ownner, and read permission to other users, the the file
